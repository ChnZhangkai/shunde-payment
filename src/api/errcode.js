...
const STATIC_ERRORCDDE = {
  ...
  RTN_100500: "预签约绑卡失败,请核实录入信息", //新加(2019-3-19)
  RTN_100501: "录入信息有误,请核实录入信息", //新加(2019-3-19)
  RTN_100502: "银行卡绑定校验失败,请确认录入信息准确无误", //新加(2019-3-19)
  RTN_100503: "请先获取短信验证码", //新加(2019-3-19)
  RTN_100504: "修改录入信息后,请重新获取短信验证码", //新加(2019-3-19)
  RTN_100505: "银行卡号校验错误,请重新输入", //新加(2019-3-19)
  RTN_100506: "验证码超时,请重新获取", //新加(2019-3-19)
  RTN_100507: "验证码错误,请重新输入", //新加(2019-3-19)
  RTN_100508: "验证码输入错误,请重新输入", //新加(2019-3-19)
  RTN_100509: "验证码格式校验错误,请重新输入", //新加(2019-3-19)
  RTN_100510: "您已绑卡成功，请直接点击“确认绑定”进入下一步操作", //新加(2019-4-4)


  RTN_200002: "新商盟账号不能为空",
  RTN_200003: "烟草许可证号不能为空",//有改动值
  RTN_200004: "借款人姓名不能为空",//有改动值
  RTN_200005: "借款人身份证号不能为空",
  RTN_200006: "申请金额不能为空",
  RTN_200007: "还款方式不能为空",
  RTN_200008: "产品编号不能为空",
  RTN_200009: "客户电话不能为空",
  ...
  CHECKBOXSTU_REGISTER_ERROR: '请勾选阅读并同意签署《使用协议》后点击立即注册',
  CHECKBOX_WRITEOTHER_PROCOL: '请勾选阅读并同意签署《银行卡代扣支付协议》后点击确认绑定',
  ...
  // ALREADY_LOGIN:"测试",
  ANDORID_VERTION_CODE:23,//低于该版本好的都不允许弹出地理位置框
...
errorCodeMap.set("100500", STATIC_ERRORCDDE.RTN_100500);//新加
errorCodeMap.set("100501", STATIC_ERRORCDDE.RTN_100501);//新加
errorCodeMap.set("100502", STATIC_ERRORCDDE.RTN_100502);//新加
errorCodeMap.set("100503", STATIC_ERRORCDDE.RTN_100503);//新加
errorCodeMap.set("100504", STATIC_ERRORCDDE.RTN_100504);//新加
errorCodeMap.set("100505", STATIC_ERRORCDDE.RTN_100505);//新加
errorCodeMap.set("100506", STATIC_ERRORCDDE.RTN_100506);//新加
errorCodeMap.set("100507", STATIC_ERRORCDDE.RTN_100507);//新加
errorCodeMap.set("100508", STATIC_ERRORCDDE.RTN_100508);//新加
errorCodeMap.set("100509", STATIC_ERRORCDDE.RTN_100509);//新加
errorCodeMap.set("100510", STATIC_ERRORCDDE.RTN_100510);//新加

errorCodeMap.set("0", STATIC_ERRORCDDE.RTN_000000);
errorCodeMap.set("000001", STATIC_ERRORCDDE.RTN_000001);
errorCodeMap.set("000002", STATIC_ERRORCDDE.RTN_000002);
...
errorCodeMap.set("000439", STATIC_ERRORCDDE.RTN_000439);
...
errorCodeMap.set("100002", STATIC_ERRORCDDE.RTN_100002);
...
errorCodeMap.set("800000", STATIC_ERRORCDDE.RTN_800000);
...
errorCodeMap.set("000005", STATIC_ERRORCDDE.ERROR_COMMON_000005);
