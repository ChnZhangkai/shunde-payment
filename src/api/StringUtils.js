...
export default{
   ...
   */
  getOpenId(){
    let openId = _this.$CACHE.getCache("loginSession");
  ...
  isLogin(){
    ...
    let openId =  _this.$CACHE.getCache("loginSession");
    return !this.isEmpty(openId) && !this.isEmpty(_this.$CACHE.getCache("loginSession"))
  },
  ...
  getPhone(){
    ...
    return this.isEmpty(sessionStorage.getItem('cachePhone')) ? sessionStorage.getItem('cacheInputPhone') : sessionStorage.getItem('cachePhone')
