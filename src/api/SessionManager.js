...
const AuthorizationActivat = 'AuthorizationActivat'
...
export default{
  ...
  clearAuthorizationActivat(target){
    sessionStorage.removeItem(this.AuthorizationActivat + 'checked');
    sessionStorage.removeItem(this.AuthorizationActivat + 'password');
    sessionStorage.removeItem(this.AuthorizationActivat + 'phone');
    sessionStorage.removeItem(this.AuthorizationActivat + 'code');
    sessionStorage.removeItem('account');
  },
  // clearAll(target){
  //   sessionStorage.removeItem(target.$options.name + 'checked')
