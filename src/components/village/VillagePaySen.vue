  ...
  <div style="width: 100%; height: 100%; position: absolute; top: 0px; font-size: 12px; background:#f7f7f7;">
    ...
    <div class="content">
      <div class="top">
        ...
        <span class="school">大良马路鱼塘002</span>
      </div>
      <div class="content1">【顺德金华村委会】*楠 130****5678</div>
    </div>
    ...
    <div class='bookline'>
      <span class="bookcon">2019年4月卫生费</span>
      <span class="amt_flag">￥50.00</span> 
    </div>
    <div class="book_num">1元/平，面积：50平</div> 

    <div class='bookline1'>
      <span class="bookcon">2019年4月水费</span>
      <span class="amt_flag">￥64.00</span> 
    </div>
    <div class="book_num">8元/方，用量：8方</div> 

    <div class='bookline1'>
      <span class="bookcon">2019年4月电费</span>
      <span class="amt_flag">￥60.00</span> 
    </div>
    <div class="book_num">0.6元/度，用量：100度</div> 
  

    <div class="total_amt">合计:￥624.00
